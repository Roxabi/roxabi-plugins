...
- T0.1: 12 — Behavior-equivalence probe (V0 GREEN-GATE)
- T1.1: 13 — Write test_browser.py RED stubs (V1 RED)
- T1.GATE: 14 — Verify V1 RED phase (V1 RED-GATE)
- T1.2: 15 — Scaffold roxabi_sdk/browser.py (V1 GREEN)
- T1.3: 16 — Implement launch_stealth_sync (V1 GREEN) [P]
- T1.4: 17 — Implement launch_stealth_async (V1 GREEN) [P]
- T1.5: 18 — Implement close_stealth helpers (V1 GREEN)
- T1.6: 19 — Fill test_browser.py assertions (V1 GREEN)
- T1.7: 20 — Polish browser.py module (V1 REFACTOR)
- T2.1: 21 — Swap imports in stealth.py (V2 GREEN)
- T2.2: 22 — Migrate fetch_html_stealth (V2 GREEN)
- T2.3: 23 — Verify test_stealth.py unchanged (V2 REFACTOR)
- T3.1: 24 — Swap imports in screenshot.py (V3 GREEN) [P]
- T3.2: 25 — Migrate capture_full_page (V3 GREEN)
- T3.3: 26 — Screenshot CLI smoke (V3 REFACTOR)
- T4.1: 27 — Write alias catchability RED test (V4 RED)
- T4.GATE: 28 — Verify V4 RED phase (V4 RED-GATE)
- T4.2: 29 — Create alias class (V4 GREEN) [P]
- T4.3: 30 — Migrate get_browser_context + fix AttributeError (V4 GREEN) [P]
- T4.4: 31 — Grep assertion for removed paths (V4 REFACTOR)
- T4.5: 32 — LinkedIn manual smoke (V4 REFACTOR)
- T5.1: 33 — Full CI gates (POST REFACTOR)
- T5.2: 34 — Import guard without playwright (POST REFACTOR)
- T5.3: 35 — Packaging + sync verification (POST REFACTOR)
- T5.4: 36 — Non-bootstrap grep counts match (POST REFACTOR)
- T5.5: 37 — sync-plugins.sh unmodified (POST REFACTOR)
