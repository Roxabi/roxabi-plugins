...
| [forge](plugins/forge/README.md) | Forge HTML for `~/.roxabi/forge/` — forge-guide (multi-tab doc), forge-epic (issue-linked), forge-chart (Mermaid), forge-gallery (5 templates: pivot, simple, comparison, audio, multi-mode) |
