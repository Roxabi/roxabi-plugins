...
| Plugin | Description |
|--------|-------------|
| [dev-core](plugins/dev-core/README.md) | Full development workflow — frame, shape, plan, implement, review, ship. 21 skills, 9 agents, safety hooks. Project-agnostic via stack.yml |
