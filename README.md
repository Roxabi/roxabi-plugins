...
| Plugin | Description |
|--------|-------------|
| [dev-core](plugins/dev-core/README.md) | Full development workflow — frame, shape, plan, implement, review, ship. 18 skills, 9 agents, safety hooks |
...
| [voice-me](plugins/voice-me/README.md) | VoiceMe assistant — author TTS scripts, generate speech, clone voices, transcribe audio |
