...
Glossary gate: `${CLAUDE_PLUGIN_ROOT}/skills/shared-refs/notation.md` ∃ → load its `## Core Table` section only; ∄ → the `Whitelist:` line (Guardrails) is the sole symbol domain — standalone install, G1–G4 still bind.
