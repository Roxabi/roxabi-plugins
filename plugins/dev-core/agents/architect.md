...
| Wrong-axis duplication (N×M trap) | — | Owned end-to-end by the `axial-adr-review` agent — see `shared-refs/axial-decomposition.md`. ¬flag here; dispatch the agent instead. |
