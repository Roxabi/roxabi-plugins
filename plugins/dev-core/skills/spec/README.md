...
Frontmatter on write: `title` (yaml-escaped), `description`, `type: spec`, `status: draft`. Approval flips `status` to `approved`. Contract: [artifact-frontmatter.md](../shared-refs/artifact-frontmatter.md).
