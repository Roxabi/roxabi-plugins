...
→ present choice **Populate {N} stub files** | **Select files** | **Cancel**
- "Select" → list files numbered, present multi-select: which to include (comma-separated indices).
...
→ present choice **Commit seeded docs** | **Review first, commit manually** | **Skip**
