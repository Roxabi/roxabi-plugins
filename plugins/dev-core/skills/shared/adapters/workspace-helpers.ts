/**
 * Pure workspace helper functions extracted from the legacy workspace.ts shim.
 * These are used by GitWorkspaceAdapter and re-exported from workspace.ts for backward compat.
 */
