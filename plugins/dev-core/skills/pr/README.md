...
- Test plan checklist
- SC→Test matrix (τ≠S) + Falsification Evidence (insert persisted `artifacts/reviews/{N}-falsify.md` — do not invent rows)
- `Fixes #N`
