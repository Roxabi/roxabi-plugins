...
- **Never enter F.** No `Class:`, no Conventional Comment label (`issue:`, `suggestion:`, `thought:`, `praise:`, `todo:`, `question:`), no `Confidence:`. `/R-fix` parses the whole PR comment; a live label here becomes a second fix task.
