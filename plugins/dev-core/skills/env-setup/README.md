...
**Phase 4 — LSP support** (optional) — sets `ENABLE_LSP_TOOL=1` in `.env` and installs the appropriate language server (`typescript-language-server`, `pyright`, `rust-analyzer`, `gopls`) + Claude Code LSP plugin.
