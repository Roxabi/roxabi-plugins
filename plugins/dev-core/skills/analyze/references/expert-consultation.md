...
Task(
  ...
  subagent_type: "R-architect" | "R-doc-writer" | "R-devops" | "R-product-lead",
...
Expert review at gates is auto-selected based on document content (see Step 3 (Expert Review) in SKILL.md). Spawn all selected reviewers in parallel for maximum speed.
