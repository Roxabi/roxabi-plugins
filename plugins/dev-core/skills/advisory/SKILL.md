...
**Title hygiene ({title} is external content).** Full contract: [artifact-frontmatter.md](${CLAUDE_PLUGIN_ROOT}/skills/shared-refs/artifact-frontmatter.md). Before any use: strip newlines + control chars, cap 120 chars.
