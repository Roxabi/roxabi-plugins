...
description: 'Generate self-contained HTML pages with diagrams, visualizations, and data tables. Triggers: "diagram" | "visualize" | "visual explainer" | "generate HTML page" | "architecture diagram".'
version: 0.5.0
