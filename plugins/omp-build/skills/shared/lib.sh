#!/usr/bin/env bash
# Shared helpers for omp-build skill state scripts. Frozen snapshot of dev-core's
# skills/shared/lib.sh (ADR-020) — copied, never resynced.
...
# ── Artifact classification (consumers: omp-build skill state scripts) ────────
